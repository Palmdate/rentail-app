...
class BuildingsTest < ApplicationSystemTestCase
  ...
  test "creating a Building" do
    ...
    fill_in "Build year", with: @building.build_year
    fill_in "Description", with: @building.description
    fill_in "Equiments", with: @building.equiments
    fill_in "Floor number", with: @building.floor_number
    fill_in "Image", with: @building.image
    fill_in "Location", with: @building.location
